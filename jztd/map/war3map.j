...
function PickupItem_Conditions takes nothing returns boolean
    ...
    if GetItemTypeId(it) == 'I066' then
        ...
        call generateRandomAttr(it2)
        call UnitAddItem((u ), ( it2)) // INLINED!!
    endif
...
call ExecuteFunc("jasshelper__initstructs591942218")
...
function jasshelper__initstructs591942218 takes nothing returns nothing
